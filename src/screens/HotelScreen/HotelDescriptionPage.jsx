...
const HotelDescriptionPage = () => {
  ...
  const HotelDetails = {
    ...
    Description: [
      ...
      {
        Name: 'Dining',
        Detail: ["Take advantage of the hostel's 24-hour room service."],
      },
      {
  ...
  return (
    <View style={{flex: 1, backgroundColor: 'white', paddingBottom: 0}}>
              ...
              {HotelDetails.HotelFacilities.map((item, index) => (
                <View
                  ...
                  <View style={{alignItems: 'center'}}>
                    <FontAwesome
                      name={getIconName(item.FontAwesome)}
                      size={20}
                      color="black"
                    />
                    <Text
      ...
      <TouchableOpacity
        style={{backgroundColor: Colors.theme_background, padding: SH(20)}}>
