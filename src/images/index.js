const images = {
  ...
  GoFistLogo: require('./GoFirst.png'),

  Exclusive1: require('./250x250.png'),
  Exclusive2: require('./250x250.png'),
  Exclusive3: require('./250x250.png'),
  Exclusive4: require('./250x250.png'),

  Offer1: require('./one_fifty.png'),
  Offer2: require('./one_fifty.png'),
  Offer3: require('./one_fifty.png'),
  ...
  Notification_one: require('./one_fifty.png'),
  Notification_two: require('./one_fifty.png'),
  ...
  rupayimage: require('./rupayimage.png'),
  PaymentSuccess: require('./250x250.png'),
  // Ticket_Qr: require('./Qr.png'),
};
